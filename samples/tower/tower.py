"""
Mask R-CNN
Train on the toy Tower dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python tower.py train --dataset=/home/kimbring2/Mask_RCNN/datasets/tower/ --weights=coco

    # Resume training a model that you had trained earlier
    python3 balloon.py train --dataset=/path/to/tower/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 tower.py train --dataset=/path/to/tower/dataset --weights=imagenet
    python tower.py train --dataset=/home/kimbring2/Mask_RCNN/samples/tower/tower_dataset --weights=imagenet
...
class TowerDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        #print("num_ids: " + str(num_ids))
        info_polygons = info["polygons"]
        #print("info_polygons: " + str(info_polygons))
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = TowerDataset()
    dataset_train.load_tower(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = TowerDataset()
    dataset_val.load_tower(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect towers.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/tower/dataset/",
                        help='Directory of the Tower dataset')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(TowerConfig):
